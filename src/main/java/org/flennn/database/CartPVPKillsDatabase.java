...
public class CartPVPKillsDatabase {
    ...
    public void addPlayer(Player player) throws SQLException{
        try(PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO cartpvpkills (player_uuid, username) VALUES (?, ?)")){
    ...
    public void addKill(Player player) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement("UPDATE cartpvpkills SET kills = ? WHERE player_uuid = ?")) {
    ...
    public void addDeath(Player player) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement("UPDATE cartpvpkills SET deaths = ? WHERE player_uuid = ?")) {
