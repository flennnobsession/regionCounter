...
public class AxeKillsDatabase {
    ...
    public void addPlayer(Player player) throws SQLException {
        try (PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO Axekills (player_uuid, username) VALUES (?, ?)")) {
    ...
    public void addKill(Player player) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement("UPDATE Axekills SET kills = ? WHERE player_uuid = ?")) {
    ...
    public void addDeath(Player player) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement("UPDATE Axekills SET deaths = ? WHERE player_uuid = ?")) {
